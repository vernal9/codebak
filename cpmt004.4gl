...
# Modify.........: No:24080007   24/08/06 By Ruby 檢查客戶產品編號是否重覆
...
#FUN-AA0059 ---------------------end-------------------------------
        ...
        AFTER FIELD obk03 
            ...
            LET l_occ74='N'
            SELECT occ74 INTO l_occ74 FROM occ_file WHERE occ01=g_obk02
            IF l_occ74='Y' AND NOT cl_null(g_obk[l_ac].obk03) THEN
               LET l_cnt=0
               SELECT count(*) INTO l_cnt FROM obk_file WHERE obk03=g_obk[l_ac].obk03 AND obk02=g_obk02 AND obk01<>g_obk[l_ac].obk01 
               IF l_cnt>0 THEN
                  CALL cl_err('','cxm-041',1)
                  LET g_obk[l_ac].obk03=g_obk_t.obk03                 
                  NEXT FIELD obk03
               END IF
            END IF
