...
#
# Pattern name...: cimi108.4gl
# Descriptions...: 料件額外品名規格明細維護作業
# Date & Author..: 2026/01/26 By momo 
# Modify.........: No.26010040 批次維護需求
...
MAIN
   ...
   END IF
    ...
    OPEN WINDOW i108_w WITH FORM "cim/42f/aimi108"
    ...
    LET l_ac_t = 0
        ...
        BEFORE ROW
            ...
            IF g_rec_b>=l_ac THEN
               ...
               OPEN i108_bcl USING g_ima_t.ima01
               IF STATUS THEN
                   CALL cl_err("OPEN i108_bcl:", STATUS, 1)
                   LET l_lock_sw = "Y"
               ELSE
                  FETCH i108_bcl INTO g_ima[l_ac].*
                  IF STATUS THEN
            ...
            END IF
           CALL i108_set_entry_b()  #FUN-6A0043
        ...
        AFTER FIELD ima140
            IF cl_null(g_ima[l_ac].ima140) OR
               ...
               NEXT FIELD ima140
            END IF
            CALL i108_set_no_entry_b()  #FUN-6A0043 add
...
#                 CALL cl_err(g_ima[l_ac].ima01,SQLCA.SQLCODE,0)  #No.FUN-660156 
    ...
    CLOSE i108_bcl
    COMMIT WORK
    CALL i108_b_fill(g_wc)    #20180507
END FUNCTION
...
#       " WHERE ", p_wc2 CLIPPED," AND imaacti='Y'",                        #FUN-A90049 mark
    ...
    DECLARE ima_curs CURSOR FOR i108_pb
...
#FUN-6A0043 add--begin
FUNCTION i108_set_entry_b()
   CALL cl_set_comp_entry("ima1401",TRUE)
END FUNCTION
 
FUNCTION i108_set_no_entry_b()
   IF g_ima[l_ac].ima140 = 'N' THEN
