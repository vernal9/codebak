...
# Modify.........: No.FUN-E60050 14/08/21 By ycchao 相關文件DB檔案資料匯出實體檔案
# Modify.........: No.FUN-E90065 14/09/23 By ycchao 相關文件權限優化
# Modify.........: No.CHI-G50001 15/05/05 By jason  移除"相關文件權限優化"設定
# Modify.........: 20180302 檔名不可有中文，統一變更檔名; 新增時預設改為 FILE
...
DEFINE ga_gca1       DYNAMIC ARRAY OF RECORD LIKE gca_file.*   #FUN-E60050 
DEFINE ga_gcb1       DYNAMIC ARRAY OF RECORD LIKE gcb_file.*   #FUN-E60050
...
FUNCTION cl_documentList()
  ...
  DISPLAY ARRAY ga_doc TO s_doc.* ATTRIBUTE(COUNT = g_rec_b, UNBUFFERED)
      ...
      ON ACTION insert
#         LET g_action_choice="modify"                  #FUN-E90065 #Mark By CHI-G50001
#         IF cl_chk_act_auth() THEN                     #FUN-E90065 #Mark By CHI-G50001
          ...
          ELSE
             ...
             END IF
          END IF
#         ELSE                                          #FUN-E90065 #Mark By CHI-G50001
#            CALL cl_err(NULL, "lib-210", 1)            #FUN-E90065 #Mark By CHI-G50001
#            ACCEPT DISPLAY                             #FUN-E90065 #Mark By CHI-G50001
#         END IF                                        #FUN-E90065 #Mark By CHI-G50001
 
      ON ACTION open_document
          IF ARR_CURR() != 0 THEN
#            LET g_action_choice="query"                #FUN-E90065 #Mark By CHI-G50001
#            IF cl_chk_act_auth() THEN                  #FUN-E90065 #Mark By CHI-G50001
...
#            END IF                                     #FUN-E90065 #Mark By CHI-G50001
      ...
      ON ACTION delete
          IF ARR_CURR() != 0 THEN
             IF NOT cl_checkDocumentPermission(gr_gcb.gcb12, gr_gcb.gcb13, gr_gcb.gcb14) THEN   #mark by FUN-E90065 #Open By GHI-G50001
#            LET g_action_choice="delete"                                                        #FUN-E90065 #Mark By CHI-G50001
#            IF NOT cl_chk_act_auth() THEN                                                       #FUN-E90065 #Mark By CHI-G50001
      ...
      ON ACTION modify
          IF ARR_CURR() != 0 THEN
#            LET g_action_choice="modify"                                                         #FUN-E90065 #Mark By CHI-G50001
             IF NOT cl_checkDocumentPermission(gr_gcb.gcb12, gr_gcb.gcb13, gr_gcb.gcb14) THEN    #mark by FUN-E90065 #Open By CHI-G50001
#            IF NOT cl_chk_act_auth() THEN                                                        #FUN-E90065 #Mark By CHI-G50001
                   CALL cl_err(NULL, "lib-210", 1)
             ELSE
      ...
      #FUN-E60050   add --start
      #ON ACTION batch_move   
...
FUNCTION cl_createDocument()
  ...
  #LET gr_gcb.gcb02 = "DOC"   #20180302 mark
  LET gr_gcb.gcb02 = "FILE"   #20180302 modify
...
FUNCTION cl_openDocument()
  ...
  CASE gr_gcb.gcb02
       WHEN "URL"
            ...
            ##---- 20190618 add by momo (S)
            LET li_status= cl_open_doc(gr_gcb.gcb10)
            ##---- 20190618 add by momo (E)
  ...
  CASE gr_gcb.gcb02
       ...
       WHEN "FILE"
            IF NOT cl_null(gs_location) THEN
               ...
               ##-----20180302 檔名不可有中文，統一變更檔名(S) ----------------
               LET ls_fname = gr_gcb.gcb01 CLIPPED,".",os.Path.extension(gr_gcb.gcb07)  
               LET gr_gcb.gcb10=g_aza.aza136,os.path.separator(),ls_fname
               ##-----20180302 檔名不可有中文，統一變更檔名(E) ----------------
...
FUNCTION cl_checkDocumentPermission(ps_type, ps_user, ps_group)
  ...
  #FUN-E90065 mark --start-- #Open By CHI-G50001 start
  CASE ps_type
       WHEN "U"
